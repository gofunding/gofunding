...
use app\modules\log\models\LogView;

/**
 * ViewSearch represents the model behind the search form about `app\modules\log\models\LogView`.
 */
class ViewSearch extends LogView {
