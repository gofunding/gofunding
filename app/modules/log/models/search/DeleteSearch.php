...
use app\modules\log\models\LogDelete;

/**
 * DeleteSearch represents the model behind the search form about `app\modules\log\models\LogDelete`.
 */
class DeleteSearch extends LogDelete {
    ...
    public function search($params) {
        $query = LogDelete::find()->asArray();
        //$query = LogDelete::find();
