...
use app\modules\log\models\LogDownload;

/**
 * DownloadSearch represents the model behind the search form about `app\modules\log\models\LogDownload`.
 */
class DownloadSearch extends LogDownload {
    ...
    public function search($params) {
        $query = LogDownload::find()->asArray();
        //$query = LogDownload::find();
