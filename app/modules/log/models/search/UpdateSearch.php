...
use app\modules\log\models\LogUpdate;

/**
 * UpdateSearch represents the model behind the search form about `app\modules\log\models\LogUpdate`.
 */
class UpdateSearch extends LogUpdate {
    ...
    public function search($params) {
        $query = LogUpdate::find()->asArray();
        //$query = LogUpdate::find();
