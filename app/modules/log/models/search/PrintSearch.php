...
use app\modules\log\models\LogPrint;

/**
 * PrintSearch represents the model behind the search form about `app\modules\log\models\LogPrint`.
 */
class PrintSearch extends LogPrint {
