...
use app\modules\log\models\LogCreate;

/**
 * CreateSearch represents the model behind the search form about `app\modules\log\models\LogCreate`.
 */
class CreateSearch extends LogCreate {
    ...
    public function search($params) {
        $query = LogCreate::find()->asArray();
        //$query = LogCreate::find();
