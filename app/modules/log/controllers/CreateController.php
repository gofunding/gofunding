...
use app\modules\log\models\search\CreateSearch;
...
// retrun nya json
    ...
    protected function findModel($id) {
        if (($model = LogCreate::findOne($id)) !== null) {
            return $model;
        } else {
