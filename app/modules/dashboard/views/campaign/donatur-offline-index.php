...
/* @var $searchModel app\modules\dashboard\models\search\DonaturOfflineSearch */
...
<br>
<div class="panel">
    <div class="donatur-offline-index panel-body">
        ...
        <?= Html::a('<i class="glyphicon glyphicon-plus glyphicon-sm"></i> Donatur Offline ', ['/dashboard/campaign/donatur-offline-create', 'id' => $_GET['id']], ['data-pjax' => 0, 'class' => 'btn btn-success btn-tambah1 btn-sm'])
            ...
            GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'format' => 'raw',
                        'value' => function ($data) {
                            return Yii::$app->formatter->asDate($data['tanggal_donasi']);
                        }
                    ],
                    // 'created_at',
                    // 'updated_at',
                    ...
                    [
                        ...
                        'buttons' => [
                            'update' => function($url, $model) {
                                ...
                                $url = ['/dashboard/campaign/donatur-offline-update', 'id' => $model['campaign_id'], 'd' => $model['id']];

                                return Html::a($icon, $url, ['title' => Yii::t('app', 'Update'),
                                        'url' => $url,
                                        'id' => 'btn-update',
                                        'data-pjax' => 0,
                                ]);
                            ...
                            'delete' => function($url, $model) {
                                ...
                                $url = ['/dashboard/campaign/donatur-offline-delete', 'id' => $model['campaign_id'], 'd' => $model['id']];

                                return Html::a($icon, $url, ['url' => $url,
                                        'title' => Yii::t('app', 'Delete'),
                                        'data' => ['confirm' => text::confirm_delete,
                                            'method' => 'post',
                                        ],
                                        'data-pjax' => 0,
                                ]);
