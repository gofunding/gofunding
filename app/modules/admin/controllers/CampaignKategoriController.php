...
use app\models\CampaignKategori;
    use app\models\search\CampaignKategoriSearch;
...
class CampaignKategoriController extends Controller
 {
...
{
    $searchModel = new CampaignKategoriSearch();
...
$model = CampaignKategori::findOne($key);
if($model->delete())
$status=1;
else
$status=2;
...
//$model = CampaignKategori::findOne($keys);
//$model->delete();
//$status=3;
}
// retrun nya json
...
{
if (($model = CampaignKategori::findOne($id)) !== null) {
return $model;
} else {
