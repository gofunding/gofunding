...
/* @var $searchModel app\modules\admin\models\search\BannerSearch */
            ...
            GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'format' => 'raw',
                        'value' => function ($data) {
                            return '<img style="width: 100%" src="' . Yii::$app->helpers->displayImage('banner', $data['path']) . '">';
                        }
                    ],
                    'order',
                    [
                        'filter' => Yii::$app->globalFunction->isActive(),
                        'attribute' => 'is_active',
                        'value' => function ($data) {
