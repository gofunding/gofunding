...
<div class="campaign-view">
    ...
    <div class="row">
        ...
        <div class="col-md-5">
            <div class="row">
                <div class="col-md-12">
                    <h2><?= Html::encode($formatter->asCurrency($model->target_donasi)) ?></h2>
                    <p>terkumpul dari target <?= Html::encode($formatter->asCurrency($model->terkumpul)) ?> </p>
                    <div class="progress">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <?php foreach ($donatur as $k => $v) { ?>
                <div class="col-md-2">
                    <img  width="60" src="<?= Yii::$app->params['defaultImage']; ?>">
                </div>
                <div class="col-md-10">
